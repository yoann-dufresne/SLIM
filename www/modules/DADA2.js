class Dada2Module extends Module {
  ...
  onLoad () {
    ...
    let fwd = this.dom.getElementsByClassName('param_value')[0].getElementsByTagName('fwd')[0];
    let rev = this.dom.getElementsByClassName('param_value')[1].getElementsByTagName('rev')[0];
