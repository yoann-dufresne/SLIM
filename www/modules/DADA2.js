class Dada2Module extends Module {
  ...
  onLoad () {
    ...
    let fwd = this.dom.getElementsByClassName('input_list')[1].getElementsByTagName('fwd')[0];
    let rev = this.dom.getElementsByClassName('input_list')[2].getElementsByTagName('rev')[0];
