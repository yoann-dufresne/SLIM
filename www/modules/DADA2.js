class Dada2Module extends Module {
  ...
  onLoad () {
    ...
    let fwd = this.dom.getElementsByClassName('input_list')[0].getElementsByTagName('fwd')[0];
    let rev = this.dom.getElementsByClassName('input_list')[1].getElementsByTagName('rev')[0];
