...
class SwarmModule extends Module {
	constructor (params) {
		super ("swarm", "https://github.com/yoann-dufresne/SLIM/wiki/Swarm-module");
...
module_manager.moduleCreators['swarm'] = (params) => {
	return new SwarmModule(params);
};
